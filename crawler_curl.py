#!/usr/bin/env python3
"""
Fast crawler using curl requests with mobile User-Agent
"""
...
def curl_get(url, timeout=30):
    """Fetch URL using curl with mobile UA"""
    try:
...
def main():
    print("=" * 60)
    print("OMC StepperOnline Fast Crawler (curl)")
    print("=" * 60)
